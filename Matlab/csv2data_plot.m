function [measures,labels,data]=csv2data_plot(data_csv)
% CSV2DATA_PLOT   Get all graph data contained in a csv file in order to
% plot it (Biiplot or Spiderplot)
%
...
%
%   See also TXT2GRAPH,CSV2GRAPH,CSV2DATA,BIIPLOT,SPIDERPLOT
...
measures=cell(size(str{1},1)-1,1);
for i=2:size(str{1},1)
    measures{i-1}=str{1}{i};
end
% Get data
